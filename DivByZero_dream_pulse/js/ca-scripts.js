...
function toggleColors() {
    ...
    let sideNav = document.querySelectorAll('.tm-white-rect')
    
    for (i=0; i<sideNav.length;i++){
    sideNav[i].classList.remove('tm-white-rect');
    sideNav[i].classList.add('tm-blue-rect');
    }
};  

function hideElement() {
    //<ul class="nav flex-row tm-social-links">  <!--todo: Hide social links-->
        var socialLinks = document.getElementsByClassName('.nav flex-row tm-social-links')
        socialLinks.hideElement ='True';
};
